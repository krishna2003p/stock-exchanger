...
STRIKE_PRICE = "0"
MAX_THREADS = 25
STOCK_CODES = ['BHAAIR', 'MARUTI', 'LARTOU', 'ULTCEM', 'TCS', 'NTPC', 'JSWSTE', 'GRASIM', 'HERHON', 'TECMAH', 'HINDAL', 'HINLEV', 'POWGRI', 'ADAPOR', 'APOHOS', 'INFTEC', 'ITC', 'BAAUTO', 'BAFINS', 'NESIND', 'JIOFIN', 'TRENT', 'MAHMAH', 'COALIN', 'SBILIF', 'ASIPAI', 'ONGC', 'ADAENT', 'RELIND', 'BAJFI', 'SUNPHA', 'TATGLO', 'TATMOT', 'TATSTE', 'TITIND', 'WIPRO', 'BHAELE', 'SHRTRA', 'HDFSTA', 'ZOMLIM', 'CIPLA', 'HCLTEC', 'DRREDD', 'EICMOT', 'NIFTY'] # example
...
public_folder = os.path.join(home, 'Documents', 'Stock_Market', 'future', 'nifty_50','1_minute_data')

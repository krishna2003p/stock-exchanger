    ...
    try:
        ...
        for _, row in df.iterrows():
            ...
            if dt < MIN_ENTRY_DATE:
                ...
                continue  # ⛔ Skip entries before 2011
        ...
        result_df.to_csv(f"{symbol}_backtest_percentage9.csv", index=False)

...
credential_users = ['VACHI','RAMKISHAN', 'RAMKISHANHUF']
# credential_users = ['SWADESHHUF']
...
public_folder = os.path.join(home, 'Documents', 'Stock_Market', 'options', '1_day_data')
...
def fetch_option_data(stock_code, expiry, right, strike, breeze_conn, max_retries = 5):
    ...
    while attempts < max_retries:
        ...
        try:
            ...
            data = conn.get_historical_data(
                interval=INTERVAL,
                from_date='2025-01-07T09:15:00.000Z',
                to_date='2025-01-07T09:15:00.000Z',
                stock_code=stock_code,
                exchange_code=EXCHANGE_CODE,
                product_type=PRODUCT_TYPE,
                expiry_date='2025-08-09T09:15:00.000Z',
                right=right,
                strike_price=str(strike)
            )
            print(f"data:: {data}")
...
def main():
    ...
    with ThreadPoolExecutor(max_workers=MAX_THREADS) as executor:
        ...
        for i, stock_code in enumerate(STOCK_CODES):
            ...
            # load daily file
            daily_file = f"/Users/apple/Documents/Stock_Market/future/index_data/1_day_data/{stock_code}.csv"

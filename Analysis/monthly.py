...
output_monthly_path = os.path.join(home, "Documents", "Stock_Market", "Final_Result", "new_output", "master_file_case6_monthly.xlsx")
output_stockwise_path = os.path.join(home, "Documents", "Stock_Market", "Final_Result", "new_output", "master_file_case6_stockwise_monthly.xlsx")
